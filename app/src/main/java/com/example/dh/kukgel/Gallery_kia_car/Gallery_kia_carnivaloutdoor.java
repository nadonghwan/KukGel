...
public class Gallery_kia_carnivaloutdoor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnivaloutdoor1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnivaloutdoor2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnivaloutdoor3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_carnivaloutdoor.this);
