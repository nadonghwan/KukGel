...
public class Gallery_kia_crens extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_crens1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_crens2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_crens3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_crens.this);
