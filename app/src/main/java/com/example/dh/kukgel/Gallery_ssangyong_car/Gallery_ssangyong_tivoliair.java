...
public class Gallery_ssangyong_tivoliair extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_tivoliair1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_tivoliair2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_tivoliair3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_ssangyong_tivoliair.this);
