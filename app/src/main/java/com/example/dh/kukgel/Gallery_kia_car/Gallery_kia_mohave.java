...
public class Gallery_kia_mohave extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_mohave1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_mohave2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_mohave3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_mohave.this);
