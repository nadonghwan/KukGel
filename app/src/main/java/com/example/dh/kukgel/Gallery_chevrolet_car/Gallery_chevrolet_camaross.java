...
public class Gallery_chevrolet_camaross extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_camaross1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_camaross2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_camaross3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_camaross.this);
