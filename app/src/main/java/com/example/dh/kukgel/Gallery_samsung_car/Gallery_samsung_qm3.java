...
public class Gallery_samsung_qm3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_qm31, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_qm32, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_qm33, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_qm3.this);
