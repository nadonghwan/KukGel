...
public class Gallery_kia_kthree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kthree1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kthree2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kthree3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_kthree.this);
