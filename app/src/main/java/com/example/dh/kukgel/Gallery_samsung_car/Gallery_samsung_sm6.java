...
public class Gallery_samsung_sm6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm61, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm62, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm63, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_sm6.this);
