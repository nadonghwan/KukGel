...
public class Gallery_kia_carnival extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnival1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnival2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnival3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_carnival.this);
