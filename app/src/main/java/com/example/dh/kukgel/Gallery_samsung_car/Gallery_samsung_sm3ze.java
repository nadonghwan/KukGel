...
public class Gallery_samsung_sm3ze extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm3ze1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm3ze2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm3ze3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_sm3ze.this);
