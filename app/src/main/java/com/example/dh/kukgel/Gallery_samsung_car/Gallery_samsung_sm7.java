...
public class Gallery_samsung_sm7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm71, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm72, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm73, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_sm7.this);
