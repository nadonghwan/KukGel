...
public class Gallery_chevrolet_trax extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_trax1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_trax2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_trax3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_trax.this);
