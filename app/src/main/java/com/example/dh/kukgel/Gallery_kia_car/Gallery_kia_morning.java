...
public class Gallery_kia_morning extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_morning1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_morning2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_morning3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_morning.this);
