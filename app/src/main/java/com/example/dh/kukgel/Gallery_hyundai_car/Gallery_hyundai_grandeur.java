...
public class Gallery_hyundai_grandeur extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_grandeur1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_grandeur2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_grandeur3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_grandeur.this);
