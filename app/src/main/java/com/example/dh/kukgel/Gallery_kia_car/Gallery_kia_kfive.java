...
public class Gallery_kia_kfive extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kfive1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kfive2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kfive3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_kfive.this);
