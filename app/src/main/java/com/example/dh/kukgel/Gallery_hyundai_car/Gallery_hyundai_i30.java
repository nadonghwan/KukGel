...
public class Gallery_hyundai_i30 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_i301, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_i302, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_i303, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_i30.this);
