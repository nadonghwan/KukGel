...
public class Gallery_ssangyong_korandoc extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_korandoc1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_korandoc2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_korandoc3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_ssangyong_korandoc.this);
