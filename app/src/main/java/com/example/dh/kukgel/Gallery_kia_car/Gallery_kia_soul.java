...
public class Gallery_kia_soul extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_soul1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_soul2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_soul3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_soul.this);
