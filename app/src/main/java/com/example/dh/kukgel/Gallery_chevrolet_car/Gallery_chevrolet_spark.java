...
public class Gallery_chevrolet_spark extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_spark1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_spark2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_spark3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_spark.this);
