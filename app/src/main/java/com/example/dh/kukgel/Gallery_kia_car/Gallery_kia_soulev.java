...
public class Gallery_kia_soulev extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_soulev1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_soulev2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_soulev3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_soulev.this);
