...
public class Gallery_chevrolet_orlando extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_orlando1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_orlando2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_orlando3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_orlando.this);
