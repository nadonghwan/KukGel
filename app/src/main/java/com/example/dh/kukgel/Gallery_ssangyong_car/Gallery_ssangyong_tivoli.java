...
public class Gallery_ssangyong_tivoli extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_tivoli1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_tivoli2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_tivoli3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_ssangyong_tivoli.this);
