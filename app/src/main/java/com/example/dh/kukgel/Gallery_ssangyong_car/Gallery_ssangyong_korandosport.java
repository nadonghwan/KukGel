...
public class Gallery_ssangyong_korandosport extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_korandosport1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_korandosport2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_korandosport3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_ssangyong_korandosport.this);
