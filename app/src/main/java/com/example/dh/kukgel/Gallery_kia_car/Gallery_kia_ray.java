...
public class Gallery_kia_ray extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_ray1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_ray2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_ray3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_ray.this);
