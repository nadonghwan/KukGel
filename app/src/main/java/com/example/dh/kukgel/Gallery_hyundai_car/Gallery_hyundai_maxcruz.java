...
public class Gallery_hyundai_maxcruz extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_maxcruz1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_maxcruz2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_maxcruz3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_maxcruz.this);
