...
public class Gallery_chevrolet_aveo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_aveo1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_aveo2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_aveo3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_aveo.this);
