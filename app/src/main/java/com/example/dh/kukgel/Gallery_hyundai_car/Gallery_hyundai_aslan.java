...
public class Gallery_hyundai_aslan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_aslan1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_aslan2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_aslan3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_aslan.this);
