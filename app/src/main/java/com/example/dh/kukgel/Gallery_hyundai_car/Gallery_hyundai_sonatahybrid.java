...
public class Gallery_hyundai_sonatahybrid extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonatahybrid1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonatahybrid2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonatahybrid3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_sonatahybrid.this);
