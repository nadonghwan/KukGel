...
public class Gallery_kia_kthreekoup extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kthreekoup1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kthreekoup2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kthreekoup3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_kthreekoup.this);
