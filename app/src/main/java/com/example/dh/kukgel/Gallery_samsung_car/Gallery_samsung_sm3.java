...
public class Gallery_samsung_sm3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm31, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm32, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm33, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_sm3.this);
