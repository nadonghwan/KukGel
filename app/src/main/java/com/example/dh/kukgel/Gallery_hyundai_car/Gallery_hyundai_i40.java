...
public class Gallery_hyundai_i40 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_i401, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_i402, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_i403, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_i40.this);
