...
public class Gallery_samsung_sm5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm51, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm52, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_sm53, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_sm5.this);
