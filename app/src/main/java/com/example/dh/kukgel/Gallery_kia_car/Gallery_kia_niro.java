...
public class Gallery_kia_niro extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_niro1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_niro2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_niro3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_niro.this);
