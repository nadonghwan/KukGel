...
public class Gallery_chevrolet_impala extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_impala1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_impala2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_impala3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_impala.this);
