...
public class Gallery_hyundai_santafe extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_santafe1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_santafe2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_santafe3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_santafe.this);
