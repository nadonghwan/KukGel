...
public class Gallery_hyundai_accent extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_accent1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_accent2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_accent3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_accent.this);
