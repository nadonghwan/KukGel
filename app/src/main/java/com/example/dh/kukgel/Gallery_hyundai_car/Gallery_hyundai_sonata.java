...
public class Gallery_hyundai_sonata extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonata1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonata2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonata3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_sonata.this);
