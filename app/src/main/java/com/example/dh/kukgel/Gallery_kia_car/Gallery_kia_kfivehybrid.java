...
public class Gallery_kia_kfivehybrid extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kfivehybrid1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kfivehybrid2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_kfivehybrid3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_kfivehybrid.this);
