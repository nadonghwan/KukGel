...
public class Gallery_hyundai_tucsonixfuelcell extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_tucsonixfuelcell1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_tucsonixfuelcell2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_tucsonixfuelcell3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_tucsonixfuelcell.this);
