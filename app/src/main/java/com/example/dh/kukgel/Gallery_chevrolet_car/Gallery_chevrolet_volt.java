...
public class Gallery_chevrolet_volt extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_volt1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_volt2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_volt3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_volt.this);
