...
public class Gallery_chevrolet_captiva extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_captiva1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_captiva2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_captiva3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_captiva.this);
