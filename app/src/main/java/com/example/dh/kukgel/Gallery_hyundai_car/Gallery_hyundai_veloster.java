...
public class Gallery_hyundai_veloster extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_veloster1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_veloster2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_veloster3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_veloster.this);
