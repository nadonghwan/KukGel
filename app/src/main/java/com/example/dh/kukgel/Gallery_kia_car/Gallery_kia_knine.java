...
public class Gallery_kia_knine extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_knine1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_knine2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_knine3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_knine.this);
