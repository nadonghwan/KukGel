...
public class Gallery_hyundai_sonatapluginhybrid extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonatapluginhybrid1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonatapluginhybrid2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_sonatapluginhybrid3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_sonatapluginhybrid.this);
