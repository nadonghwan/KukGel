...
public class Gallery_kia_sportage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_sportage1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_sportage2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_sportage3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_sportage.this);
