...
public class Gallery_kia_sorento extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_sorento1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_sorento2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_sorento3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_sorento.this);
