...
public class Gallery_samsung_qm5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_qm51, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_qm52, null));
        pageViews.add(inflater.inflate(R.layout.gallery_samsung_qm53, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_samsung_qm5.this);
