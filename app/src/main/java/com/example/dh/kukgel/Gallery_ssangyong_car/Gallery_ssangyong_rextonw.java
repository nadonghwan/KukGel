...
public class Gallery_ssangyong_rextonw extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_rextonw1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_rextonw2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_rextonw3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_ssangyong_rextonw.this);
