...
public class Gallery_kia_pride extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_pride1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_pride2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_pride3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_pride.this);
