...
public class Gallery_hyundai_tucson extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_tucson1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_tucson2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_tucson3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_tucson.this);
