...
public class Gallery_hyundai_ioniqelectric extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_ioniqelectric1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_ioniqelectric2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_ioniqelectric3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_ioniqelectric.this);
