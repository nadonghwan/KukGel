...
public class Gallery_ssangyong_chairmanw extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_chairmanw1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_chairmanw2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_ssangyong_chairmanw3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_ssangyong_chairmanw.this);
