...
public class Gallery_chevrolet_malibu extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_malibu1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_malibu2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_malibu3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_malibu.this);
