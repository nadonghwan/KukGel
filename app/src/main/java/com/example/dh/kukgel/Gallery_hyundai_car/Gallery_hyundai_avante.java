...
public class Gallery_hyundai_avante extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_avante1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_avante2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_hyundai_avante3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_hyundai_avante.this);
