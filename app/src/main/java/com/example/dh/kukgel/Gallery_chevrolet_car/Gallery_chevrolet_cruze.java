...
public class Gallery_chevrolet_cruze extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_cruze1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_cruze2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_chevrolet_cruze3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_chevrolet_cruze.this);
