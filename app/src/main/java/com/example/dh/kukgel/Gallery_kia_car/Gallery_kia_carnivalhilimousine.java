...
public class Gallery_kia_carnivalhilimousine extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnivalhilimousine1, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnivalhilimousine2, null));
        pageViews.add(inflater.inflate(R.layout.gallery_kia_carnivalhilimousine3, null));
        ...
        for(int i=0;i<pageViews.size();i++){
            imageView = new ImageView(Gallery_kia_carnivalhilimousine.this);
